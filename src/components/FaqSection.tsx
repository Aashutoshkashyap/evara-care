...
export default function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Every time a service is completed, a detailed report (including doctor's notes, lab results, and prescriptions) is uploaded directly to your secure Evara dashboard. You'll receive real-time notifications on your phone.",
    },
    {
    ...
    },
    {
      ...
      answer: "You can load funds into your Evara Wallet or link a credit card. When a doctor visits or medicine is delivered, we transparently deduct the exact cost of the service. No hidden markups.",
    },
  ];
    ...
    <section id="faq" className="max-w-3xl mx-auto px-8 py-20">
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-gray-500 text-[15px]">
          Everything you need to know about Evara.
        </p>
      </div>
        ...
        {faqs.map((faq, index) => (
          <div
            ...
            className={`border rounded-xl overflow-hidden transition-colors ${
              openIndex === index ? "border-[#0f766e]/30 bg-[#0f766e]/5" : "border-gray-200 bg-white"
            }`}
          >
            <button
            ...
            >
              ...
              <ChevronDown
                ...
                className={`flex-shrink-0 transition-transform duration-300 ${
                  openIndex === index ? "rotate-180 text-[#0f766e]" : "text-gray-400"
                }`}
              />
            </button>
            <div
