        ...
        {faqs.map((faq, index) => (
          <div
            ...
            className={`border rounded-xl overflow-hidden transition-colors ${
              openIndex === index ? "border-[#000080]/30 bg-[#000080]/5" : "border-gray-200 bg-white"
            }`}
          >
            <button
            ...
            >
              <span className={`font-semibold text-[15px] pr-4 ${openIndex === index ? "text-[#000080]" : "text-[#111]"}`}>
                {faq.question}
              </span>
              <ChevronDown
                size={20}
                className={`flex-shrink-0 transition-transform duration-300 ${
                  openIndex === index ? "rotate-180 text-[#000080]" : "text-gray-400"
                }`}
              />
            </button>
            <div
