    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full px-8 relative z-10 flex justify-end">
        ...
        <div className="bg-white/95 backdrop-blur-md p-10 md:p-12 rounded-2xl shadow-2xl w-full max-w-[480px]">
          <p className="text-[#020924] font-bold tracking-widest text-sm uppercase mb-3">
            Avora Care Family Care
          </p>
          ...
          <button className="bg-[#020924] hover:bg-[#020924] text-white px-10 py-4 rounded-full font-bold transition-colors shadow-lg">
            START CARING TODAY
          </button>
        </div>
