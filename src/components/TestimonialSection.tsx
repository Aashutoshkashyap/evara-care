      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start relative z-10">
          ...
          <div className="flex flex-col gap-6 pt-12">
            ...
            {/* Card 2 - Blue accent */}
            <div className="bg-[#000080] text-white rounded-3xl p-8 shadow-lg relative group hover:-translate-y-1 transition-transform">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm relative mt-8 text-center group hover:shadow-md transition-shadow">
              ...
              <p className="font-bold text-[#000080]">Priya Thapa</p>
          ...
          <div className="flex flex-col gap-6 pt-16">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm relative group hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-end gap-3 relative z-10">
                <p className="font-bold text-[#000080] text-xs">Dipesh Pandey <span className="text-gray-400 font-normal"> - Toronto, Canada</span></p>
              </div>
            </div>
