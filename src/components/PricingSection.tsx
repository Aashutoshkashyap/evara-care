      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              {plan.isPopular && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#191970] text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg whitespace-nowrap tracking-wide uppercase">
                  Most Popular
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                {plan.features.map((feature, fIndex) => (
                  <div key={fIndex} className="flex items-start gap-3">
                    <div className={`mt-1 p-0.5 rounded-full flex-shrink-0 ${plan.isPopular ? 'bg-white/20 text-white' : 'bg-blue-50 text-[#191970]'}`}>
