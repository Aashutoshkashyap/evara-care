      ...
      <div className="max-w-6xl mx-auto px-8 flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        <div className="w-full md:w-[40%] flex flex-col items-start">
          ...
          <p className="text-gray-600 text-[15px] leading-relaxed mb-8 max-w-[400px]">
            Working abroad means you can&apos;t always be there in person. Avora Care is a dedicated family care coordination system. We bridge the gap by managing doctor appointments, delivering medicines, facilitating lab tests, and providing emergency support locally.
          </p>
          <button className="bg-[#020924] hover:bg-[#020924] text-white px-10 py-4 rounded-full font-bold tracking-wider text-sm transition-colors shadow-lg">
            LEARN MORE
          </button>
        </div>
        ...
        <div className="w-full md:w-[60%] relative flex justify-center items-center min-h-[500px]">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[350px] md:h-[350px] bg-[#020924] rounded-full -z-0 translate-x-[30%]"></div>
          {/* Main Image */}
          <img
