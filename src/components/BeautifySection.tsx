    ...
    <section id="about" className="w-full bg-[#eef2f8] py-16 md:py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-8 flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        <div className="w-full md:w-[40%] flex flex-col items-start">
          ...
          <button className="bg-[#191970] hover:bg-[#0a0a40] text-white px-10 py-4 rounded-full font-bold tracking-wider text-sm transition-colors shadow-lg">
            LEARN MORE
          </button>
        </div>
        ...
        <div className="w-full md:w-[60%] relative flex justify-center items-center min-h-[500px]">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[350px] md:h-[350px] bg-[#191970] rounded-full -z-0 translate-x-[30%]"></div>
          {/* Main Image */}
          <img
