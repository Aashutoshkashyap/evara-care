...
export default function FeaturesBar() {
  const features = [
    {
      icon: <Stethoscope size={40} className="text-[#020924]" strokeWidth={1.5} />,
      title: "Doctor Consultations",
      description: "Top local specialists",
    },
    {
      icon: <Pill size={40} className="text-[#020924]" strokeWidth={1.5} />,
      title: "Pharmacy Delivery",
      description: "Medicines to their door",
    },
    {
      icon: <TestTube size={40} className="text-[#020924]" strokeWidth={1.5} />,
      title: "At-Home Lab Tests",
      description: "Convenient diagnostics",
    },
    {
      icon: <Ambulance size={40} className="text-[#020924]" strokeWidth={1.5} />,
