  ...
  return (
    <section className="w-full bg-white py-12 md:py-20">
      <div className="max-w-4xl mx-auto px-8">
        <div className="bg-[#0f766e] rounded-[2rem] overflow-hidden relative shadow-xl">
          ...
          <div className="relative z-10 p-12 md:p-20 flex flex-col items-center text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-4">
              Try the Evara app <br className="hidden md:block" /> for free for 14 days
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {/* App Store Button */}
              <button className="bg-white hover:bg-gray-100 transition-colors text-[#0f766e] rounded-xl px-5 py-3 flex items-center gap-3 shadow-md min-w-[160px]">
