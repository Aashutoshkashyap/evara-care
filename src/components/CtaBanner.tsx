  ...
  return (
    <section className="w-full bg-white py-12 md:py-20">
      <div className="max-w-4xl mx-auto px-8">
        <div className="bg-[#020924] rounded-[2rem] overflow-hidden relative shadow-xl">
          ...
          <div className="relative z-10 p-12 md:p-20 flex flex-col items-center text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {/* App Store Button */}
              <button className="bg-white hover:bg-gray-100 transition-colors text-[#020924] rounded-xl px-5 py-3 flex items-center gap-3 shadow-md min-w-[160px]">
