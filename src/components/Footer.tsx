...
export default function Footer() {
  return (
    <footer className="bg-[#0d2c4a] text-white pt-24 pb-12 w-full mt-auto relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#000080]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-12 lg:col-span-4 flex flex-col pr-8">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <div className="w-5 h-5 bg-[#000080] rounded-full"></div>
            ...
            <div className="flex items-center gap-4 mt-auto">
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#000080] transition-all duration-300">
              ...
              <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#000080] transition-all duration-300">
              ...
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#000080] transition-all duration-300">
